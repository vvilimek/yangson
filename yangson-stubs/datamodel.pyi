...
from .schemadata import SchemaContext, SchemaData, SchemaDataFactory
from .schemanode import DataNode, SchemaNode, SchemaTreeNode, SchemaTreeFactory
from .typealiases import DataPath, PrefName, SchemaPath, RawObject
from typing import Optional

class DataModel:
    @classmethod
    def from_file(cls, name: str, mod_path: tuple[str, ...] = ('.',), description: Optional[str] = None, data_factory: Optional[SchemaDataFactory] = None, tree_factory: Optional[SchemaTreeFactory] = None) -> DataModel: ...
    yang_library: dict[str, str]
    schema_data: SchemaData
    schema: SchemaTreeNode
    def __init__(self, yltxt: str, mod_path: tuple[str, ...] = ('.',), description: Optional[str] = None, data_factory: Optional[SchemaDataFactory] = None, tree_factory: Optional[SchemaTreeFactory] = None) -> None: ...
